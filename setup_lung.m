...
%cref=concentration of oxygen in air at sea level at body temperature
...
%oxygen partial pressure at which hemoglobin is half-saturated:
Pstar=25

%gas constant*absolute temperature (mmHg*liters/mole):
RT=760*22.4*(310/273)

%oxygen partial pressure in the inspired air (mmHg):
PI=RT*cI

%oxygen concentration in blood exposed directly to inspired air:
%camax is an upper bound on oxygen concentration in blood 

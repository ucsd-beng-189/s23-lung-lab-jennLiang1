...
%starting from the value of cv determined by cvsolve, 
%solve for all other unknowns:
%concentrations and partial pressures in the individual alveoli:

%vector of oxygen concentrations in arterial blood leaving each alveolus:
ca=carterial(cv,r);

%vector of oxygen partial pressures in arterial blood leaving each alveolus:
Pa=H(ca);
...
%(plot individual points instead of lines since r values are not in order)
